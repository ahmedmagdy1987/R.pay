...
export default function Page() {
  ...
  return (
    <>
      ...
      <a className="concept-back" href="/" aria-label="All concepts">
      ...
      <section className="hero" id="top">
        ...
        <div className="hgrid">
          <div className="hero-copy">
            ...
            <div className="pay-block rv d4">
              {/* Supported payment methods (restored premium brand chips) */}
              <div className="pay-methods">
                <span className="pay-lb"><span className="ar-t">وسائل الدفع المدعومة</span><span className="en-t">Supported payments</span></span>
                <div className="pay-brands">
                  <span className="brand-chip" aria-label="mada"><b className="bc-mada">mada</b></span>
                  <span className="brand-chip" aria-label="Visa"><b className="bc-visa">VISA</b></span>
                  <span className="brand-chip" aria-label="Mastercard">
                    <svg className="bc-mc" viewBox="0 0 40 24" aria-hidden="true"><circle cx="16" cy="12" r="9" fill="#EB001B" /><circle cx="24" cy="12" r="9" fill="#F79E1B" /><path d="M20 5.2a8.98 8.98 0 0 0 0 13.6 8.98 8.98 0 0 0 0-13.6Z" fill="#FF5F00" /></svg>
                  </span>
                  <span className="brand-chip" aria-label="Apple Pay">
                    <svg className="bc-apay" viewBox="0 0 20 24" aria-hidden="true"><path d="M13.6 4.2c.7-.9 1.2-2 1-3.2-1 .05-2.2.7-2.9 1.5-.6.7-1.2 1.9-1 3 1.1.1 2.2-.5 2.9-1.3Z" /><path d="M14.9 6.3c-1.6-.1-3 .9-3.7.9-.8 0-2-.9-3.3-.85-1.7.02-3.3 1-4.1 2.5-1.8 3-.5 7.6 1.3 10.1.9 1.2 1.9 2.6 3.2 2.5 1.3-.05 1.8-.83 3.3-.83 1.5 0 2 .83 3.3.8 1.4-.02 2.2-1.25 3.1-2.47.7-.9 1-1.4 1.5-2.44-3.9-1.5-4.5-7-.65-9.1-1-1.35-2.6-1.8-3.5-1.84Z" /></svg>
                    <b className="bc-apay-t">Pay</b>
                  </span>
                  <span className="brand-chip" aria-label="STC Pay"><b className="bc-stc">stc<i>pay</i></b></span>
                </div>
              </div>
              {/* Capability chips — cleanly wrapped, icon-led (fixes multi-channel layout) */}
              <ul className="trust-chips">
                <li className="trust-chip">
                  <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3l7 3v5c0 4.2-2.8 7.6-7 9-4.2-1.4-7-4.8-7-9V6l7-3Z" /><path d="M9 12l2 2 4-4" /></svg>
                  <span className="ar-t">دفع آمن</span><span className="en-t">Secure checkout</span>
                </li>
                <li className="trust-chip">
                  <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M13 2L4 14h6l-1 8 9-12h-6l1-8Z" /></svg>
                  <span className="ar-t">موافقة فورية</span><span className="en-t">Instant approval</span>
                </li>
                <li className="trust-chip">
                  ...
                  <span className="ar-t">مراقبة مباشرة</span><span className="en-t">Live monitoring</span>
                </li>
                <li className="trust-chip">
                  <svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2" y="4" width="14" height="10" rx="2" /><path d="M16 8h3l3 3v3h-6" /><circle cx="7" cy="18" r="2" /><circle cx="18" cy="18" r="2" /></svg>
                  <span className="ar-t">دفع متعدد القنوات</span><span className="en-t">Multi-channel payments</span>
                </li>
              </ul>
            </div>
          </div>
